...
export const getCsrfToken = async () => apiCall2('get', '/csrf/');
...
export const simple_register = async (email_username_password) => apiCall2('post', '/users/simple_register/',email_username_password);
